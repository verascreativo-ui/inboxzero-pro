 ...
 * Marcadas con notes = 'prueba-limite-19' para borrarlas después.
 *
 * Uso (desde server/): node scripts/insert-limit-test-19-cards.mjs
 */
import 'dotenv/config';

const TEST_EMAIL = 'verascreativo@gmail.com';
const CARD_COUNT = 19;
const TEST_NOTES = 'prueba-limite-19';
...
function buildTestCards(userId) {
  ...
  for (let i = 1; i <= CARD_COUNT; i += 1) {
    rows.push({
      ...
      description: `Ficha de prueba límite ${i} (inserción controlada).`,
